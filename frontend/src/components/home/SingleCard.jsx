...
const SingleCard = ({ book }) => {
    ...
    return (
        <div key={book._id} className='border-2 border-gray-500 rounded-lg px-4 py-2 m-4 relative hover:shadow-x-1'>
            <h2 className='absolute top-1 right-2 px-4 py-1 bg-red-300 rounded-lg'>{book.year}</h2>
